...
#define INPUT_FILE1 "data/sonic2_gui.wav"
#define INPUT_FILE2 "data/sonic2_vio.wav"
#define INPUT_FILE3 "data/sonic2_per.wav"
#define OUTPUT_FILE "data/teste2_mistura_aluno.wav"
